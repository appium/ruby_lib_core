  ...
  module Android
    class MobileCommandsTest < AppiumLibCoreTest::Function::TestCase
      ...
      def test_drawer
        ...
        assert_mobile_command_error 'mobile: openDrawer', { element: element_id, gravity: 1 },
                                    'Could not open drawer'
        assert_mobile_command_error 'mobile: closeDrawer', { element: element_id, gravity: 1 },
      ...
      def test_datepicker
        ...
        _, element_id = date_picker.ref
        @driver.execute_script('mobile: setDate', { year: 2020, monthOfYear: 10, dayOfMonth: 25, element: element_id })
      ...
      def test_timepicker
        ...
        @driver.execute_script('mobile: setTime', { hours: 11, minutes: 0, element: element_id })
        ...
        _, element_id = time_el.ref
        @driver.execute_script('mobile: setTime', { hours: 15, minutes: 15, element: element_id })
      ...
      def test_navigate_to
        ...
        assert_mobile_command_error 'mobile: navigateTo', { element: element_id, menuItemId: 10 },
      ...
      def test_scroll_page_on_view_pager
        ...
        _, element_id = el.ref
        assert_mobile_command_error 'mobile: scrollToPage',  { element: element_id, scrollTo: 'right' },
                                    'Could not perform scroll to on element'
        assert_mobile_command_error 'mobile: scrollToPage',  { element: element_id, scrollTo: '' },
                                    'Invalid scrollTo parameters'
        assert_mobile_command_error 'mobile: scrollToPage',  { element: element_id, scrollToPage: -100 },
                                    'be a non-negative integer'
        error = assert_raises ::Selenium::WebDriver::Error::InvalidArgumentError do
          @driver.execute_script 'mobile: scrollToPage', { element: element_id }
        end
        assert error.message.include? "Must provide either 'scrollTo' or 'scrollToPage'"

        # A test demo apk has no the element
        assert_mobile_command_error 'mobile: scrollToPage', { element: element_id, scrollToPage: 2, smoothScroll: true },
                                    'Could not perform scroll to on element'
      end
      ...
      def test_backdoor
        ...
        _, element_id = e.last.ref
        type = @driver.execute_script('mobile: backdoor',
                                      { target: :element, elementId: element_id, methods: [{ name: 'getTypeface' }] })
        assert type['mStyle']
      end
