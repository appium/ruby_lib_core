    ...
    class Base
      class Bridge
        class W3C < ::Selenium::WebDriver::Remote::W3C::Bridge
          ...
          #
          def find_element_by_image_deprecated(full_image:, partial_image:, match_threshold: nil, visualize: false)
            options = {}
          ...
          # @raise [::Selenium::WebDriver::Error::TimeOutError|::Selenium::WebDriver::Error::WebDriverError]
          #
          def find_elements_by_image_deprecated(full_image:, partial_images:, match_threshold: nil, visualize: false)
            options = {}
            options[:threshold] = match_threshold unless match_threshold.nil?
            options[:visualize] = visualize
